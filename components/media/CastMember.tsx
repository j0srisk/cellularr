...
export default function CastMember({ cast }: { cast: Cast }) {
	...
	return (
		<div className="flex w-24 flex-shrink-0 snap-start scroll-ml-4 flex-col items-center gap-2 ">
			<div className="relative flex h-24 w-24 items-center justify-center overflow-hidden rounded-full bg-gradient-to-tr from-zinc-800 to-zinc-900 text-label-secondary-dark">
				{imageUrl ? (
					<>
						<Image
							src={imageUrl}
